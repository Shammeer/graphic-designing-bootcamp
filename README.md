...
4. Upload your folder and make sure the folder name is your name which you registered in bootcamp.
...
6. Just add all your project files each time in that folder itself and add subject of each file as your name with the day of the bootcamp specified **(for example.. yourname - Day    1)**. 
